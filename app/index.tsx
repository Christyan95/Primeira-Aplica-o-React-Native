...
import { bgRed500, bgYellow500, botao, flex1, flexRow, gapX5, gapY5, input, itemsCenter, lineThrough, mb10, px2, text4Xl, textWhite, textZinc500, w9_10 } from "@/styles";
      ...
      <View style={[w9_10, gapY5]}>
        {tarefas.map((tarefa) => (
          <View key={tarefa.id} style={[flexRow, itemsCenter, gapX5]}>
            ...
            <Pressable style={[botao, bgYellow500, px2]} onPress={() => alternarConclusao(tarefa)}>
              <AntDesign name={tarefa.concluida ? 'eyeo' : 'eye'} size={16} color='white' />
            </Pressable>
